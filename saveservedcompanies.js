...
// 	contactInfo = ($("#contactCompanyName").html().trim() + " - " + $("#contactLocation").html().trim() + " - " + $("#contactPhone").html().trim()).replace(/[\n\t]/g, "");
...
// 	if (document.URL === "http://www.dice.com/")
